...
public class GDScriptBindingPatternImpl extends ASTWrapperPsiElement implements GDScriptBindingPattern {

  public GDScriptBindingPatternImpl(@NotNull ASTNode node) {
    super(node);
  }
