...
public class GDScriptAssignOperatorImpl extends ASTWrapperPsiElement implements GDScriptAssignOperator {

  public GDScriptAssignOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
