...
public class GDScriptFunctionReturnTypeImpl extends ASTWrapperPsiElement implements GDScriptFunctionReturnType {

  public GDScriptFunctionReturnTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
