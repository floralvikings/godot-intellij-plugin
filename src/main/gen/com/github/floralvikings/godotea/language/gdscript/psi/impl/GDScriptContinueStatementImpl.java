...
public class GDScriptContinueStatementImpl extends ASTWrapperPsiElement implements GDScriptContinueStatement {

  public GDScriptContinueStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
