...
public class GDScriptDictPatternImpl extends ASTWrapperPsiElement implements GDScriptDictPattern {

  public GDScriptDictPatternImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GDScriptKeyValuePattern> getKeyValuePatternList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GDScriptKeyValuePattern.class);
  }
