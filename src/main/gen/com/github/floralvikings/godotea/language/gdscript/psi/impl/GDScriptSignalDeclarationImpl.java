...
public class GDScriptSignalDeclarationImpl extends ASTWrapperPsiElement implements GDScriptSignalDeclaration {

  public GDScriptSignalDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
