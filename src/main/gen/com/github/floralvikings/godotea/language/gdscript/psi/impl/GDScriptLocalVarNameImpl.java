...
public class GDScriptLocalVarNameImpl extends ASTWrapperPsiElement implements GDScriptLocalVarName {

  public GDScriptLocalVarNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GDScriptVisitor visitor) {
    visitor.visitLocalVarName(this);
  }
