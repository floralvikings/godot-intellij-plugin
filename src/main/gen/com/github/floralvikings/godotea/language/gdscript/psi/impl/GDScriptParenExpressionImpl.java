...
public class GDScriptParenExpressionImpl extends GDScriptExpressionImpl implements GDScriptParenExpression {

  public GDScriptParenExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
