...
public class GDScriptArrayPatternImpl extends ASTWrapperPsiElement implements GDScriptArrayPattern {

  public GDScriptArrayPatternImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GDScriptPattern> getPatternList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GDScriptPattern.class);
  }
