...
public class GDScriptClassVarNameImpl extends ASTWrapperPsiElement implements GDScriptClassVarName {

  public GDScriptClassVarNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GDScriptVisitor visitor) {
    visitor.visitClassVarName(this);
  }
