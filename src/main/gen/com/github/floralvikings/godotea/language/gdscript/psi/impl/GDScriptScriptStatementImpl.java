...
public class GDScriptScriptStatementImpl extends ASTWrapperPsiElement implements GDScriptScriptStatement {

  public GDScriptScriptStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
