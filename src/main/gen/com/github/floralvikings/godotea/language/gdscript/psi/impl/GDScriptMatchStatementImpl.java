...
public class GDScriptMatchStatementImpl extends ASTWrapperPsiElement implements GDScriptMatchStatement {

  public GDScriptMatchStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
