...
public class GDScriptClassVarDeclarationStatementImpl extends ASTWrapperPsiElement implements GDScriptClassVarDeclarationStatement {

  public GDScriptClassVarDeclarationStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GDScriptVisitor visitor) {
    visitor.visitClassVarDeclarationStatement(this);
  }
  ...
  @Override
  @NotNull
  public GDScriptClassVarDeclaration getClassVarDeclaration() {
    return findNotNullChildByClass(GDScriptClassVarDeclaration.class);
  }
