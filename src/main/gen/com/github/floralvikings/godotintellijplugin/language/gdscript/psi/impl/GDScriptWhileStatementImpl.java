...
public class GDScriptWhileStatementImpl extends ASTWrapperPsiElement implements GDScriptWhileStatement {

  public GDScriptWhileStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
