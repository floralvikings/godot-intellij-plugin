...
public class GDScriptBlockSetImpl extends ASTWrapperPsiElement implements GDScriptBlockSet {

  public GDScriptBlockSetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GDScriptVisitor visitor) {
    visitor.visitBlockSet(this);
  }
