...
public class GDScriptReturnStatementImpl extends ASTWrapperPsiElement implements GDScriptReturnStatement {

  public GDScriptReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
