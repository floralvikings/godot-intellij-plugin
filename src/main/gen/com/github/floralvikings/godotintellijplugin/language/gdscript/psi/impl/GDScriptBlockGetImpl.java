...
public class GDScriptBlockGetImpl extends ASTWrapperPsiElement implements GDScriptBlockGet {

  public GDScriptBlockGetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GDScriptVisitor visitor) {
    visitor.visitBlockGet(this);
  }
