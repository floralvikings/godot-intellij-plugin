...
public class GDScriptAwaitStatementImpl extends ASTWrapperPsiElement implements GDScriptAwaitStatement {

  public GDScriptAwaitStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
