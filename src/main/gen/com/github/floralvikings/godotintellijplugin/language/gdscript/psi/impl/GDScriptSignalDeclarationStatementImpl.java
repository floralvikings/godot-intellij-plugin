...
public class GDScriptSignalDeclarationStatementImpl extends ASTWrapperPsiElement implements GDScriptSignalDeclarationStatement {

  public GDScriptSignalDeclarationStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GDScriptVisitor visitor) {
    visitor.visitSignalDeclarationStatement(this);
  }
  ...
  @Override
  @NotNull
  public GDScriptSignalDeclaration getSignalDeclaration() {
    return findNotNullChildByClass(GDScriptSignalDeclaration.class);
  }
